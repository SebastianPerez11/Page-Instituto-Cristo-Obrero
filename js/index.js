(function(){
    const listElements = document.querySelectorAll('.nav-bar-menu-item--show');
    const list = document.querySelector('.nav-bar-class-links');
    const menu = document.querySelector('.nav-bar-class-menu-hamburguer');
